...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <div>
                       ...
                       <asp:TextBox ID="txtProduct_ID" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                    ...
                    <div>
                       <label for="txtProduct_Price">定價：</label>
                        ...
                        <asp:CompareValidator ValidationGroup="ValidationInsert" ControlToValidate="txtProduct_Price" Operator="DataTypeCheck" Type="Integer" ID="CompareValidator2" runat="server" ErrorMessage="(請輸入數字)" Font-Size="10pt" ForeColor="Red" Display="Dynamic"></asp:CompareValidator>
                    </div>
                    <div>
                ...
                <div class="modal-footer">
                    <asp:Button ID="Button1" runat="server" ValidationGroup="ValidationInsert" Text="新增" CssClass="btn btn-primary" OnClick="Button1_Click" />
    ...
    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover table-striped" PagerStyle-HorizontalAlign="Center"
        ...
        <Columns>
            ...
            <asp:CommandField HeaderText="管理" ShowEditButton="True" ItemStyle-Width="80px" ItemStyle-VerticalAlign="Middle" ItemStyle-HorizontalAlign="Center">
                <ItemStyle Width="80px"></ItemStyle>
            </asp:CommandField>
        </Columns>
